      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-dark-secondary/95 backdrop-blur-sm border-b border-electric-purple/20">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="/marketplace" className="text-gray-300 hover:text-white transition-colors">Game Templates</a>
            <a href="/smart-contracts" className="text-white font-medium hover:text-electric-purple transition-colors">Smart Contracts</a>
          </nav>
