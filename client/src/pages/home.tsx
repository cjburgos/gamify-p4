...
const gameTemplates: GameTemplate[] = [
  {
    ...
    fee: "1% of prize pool",
    description:
      "Guess the Dice Roll Survivor Pool - Last player standing wins",
    icon: "🎲",
  },
  {
    id: "nfl-pick",
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Wallet */}
          <div>{isConnected ? <WalletInfo /> : <ConnectWallet />}</div>
        </div>
      </header>
      ...
      <main style={{ padding: "48px 24px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              Deploy elimination-style games where players compete for
              stablecoin prizes. Choose your template and become a GameMaster.
            </p>
          </div>
          ...
          >
            {gameTemplates.map((template) => (
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(107, 33, 168, 0.8) 0%, rgba(30, 64, 175, 0.8) 100%)",
                  borderRadius: "12px",
                ...
                <Dialog>
                  ...
                  <DialogContent
                    style={{
                      maxWidth: "400px",
                      background:
                        "linear-gradient(135deg, #6b21a8 0%, #1e40af 100%)",
          ...
          <div
            style={{
              background:
                "linear-gradient(135deg, rgba(107, 33, 168, 0.6) 0%, rgba(30, 64, 175, 0.6) 100%)",
              borderRadius: "12px",
              border: "3px solid #fbbf24",
              padding: "32px",
              backdropFilter: "blur(8px)",
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Players enter with stablecoins and compete in elimination
                  rounds
                </p>
              </div>
              <div>
