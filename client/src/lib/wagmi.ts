...
import { flowPreviewnet, flowMainnet } from 'wagmi/chains'
...
export const config = createConfig({
  chains: [flowPreviewnet, flowMainnet],
  connectors: [
    metaMask(),
...
export const TOKENS = {
  USDC: {
    [flowPreviewnet.id]: '0x', // Flow testnet USDC address
    [flowMainnet.id]: '0xA0b86991c431B0C6C7C5c16f31e8e86B8e2c0C2c2', // Flow mainnet USDC address
  },
  PYUSD: {
    [flowPreviewnet.id]: '0x', // Flow testnet PYUSD address  
